...
export default function NetflixOriginals() {
    ...
    const getTopRatedMovies = async (url: string) => {
      ...
      useEffect(() => {
        const topRatedURL = `${ListURL}discover/tv?${apiKey}&with_networks=213&language=pt-BR`;
  ...
  return (
    <div>
      <h1 className="text-3xl text-white text-left font-impact m-10 mb-5"> Netflix</h1>
