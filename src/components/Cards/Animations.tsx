...
export default function Animations() {
    ...
    const getTopRatedMovies = async (url: string) => {
      ...
      useEffect(() => {
        const topRatedURL = `${ListURL}discover/movie?${apiKey}&with_genres=16&language=pt-BR`;
  ...
  return (
        <div>
          <h1 className="text-3xl text-white text-left font-impact m-10 mb-5"> Animações</h1>
